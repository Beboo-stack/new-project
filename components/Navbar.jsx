            ...
            >
              ...
              >
                <button
                  onClick={() => setToggle(!toggle)}
                  type=""
                  className="lg:hidden hs-collapse-toggle flex justify-center items-center gap-x-2 mb-10 font-bold rounded-full bg-[#FBFBFB]/10 p-2  absolute top-5 left-5  hover:border-white/40 disabled:opacity-50 disabled:pointer-events-none"
